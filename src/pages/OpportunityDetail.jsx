...
export default function OpportunityDetail({ opp, isBookmarked, onBookmark, onBack }) {
  const deadlineStr = new Date(opp.deadline).toLocaleDateString("en-US", {
          ...
          <div style={{
            ...
            <div style={{
              ...
              {[
                ...
                { icon: "🕐", label: "Type", value: opp.type },
            ...
            <ul style={{ margin: "0 0 24px", paddingLeft: "20px", fontSize: "15px", color: "#5E6670", lineHeight: "26px" }}>
              ...
              <li>Opportunity for full-time role based on performance</li>
            </ul>
